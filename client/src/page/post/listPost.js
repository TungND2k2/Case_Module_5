                                        ...
                                        <Link to={'/jobs-detail'}>
                                            <div className="product-item">
                                                ...
                                                <div className="down-content">
                                                    <a href=""><h4 style={{color : "gray" , fontStyle : "italic"}}> {item.title}</h4></a>

                                                    <h4>${item.salary}</h4>
                                                    <h4><small><i
                                                        className="fa fa-briefcase"></i> {item.jobName + ""}<br/><i
                                                        className="fa fa-building"></i>{item.position}
                                                    </small>
                                                    </h4>
                                                    <small>
                                                    ...
                                                    <div className="container">
                                                        <Link to={`/posts/${item.idPost}`}>
                                                            <button className="btn btn-primary mt-2"><i
                                                                className="fa-solid fa-wrench"></i></button>
                                                        </Link>
